...
//	end_bc := "B6"
	...
	for turn := 0; ldepth < maxdepth && rdepth < maxdepth; turn++ {
		...
		left_paths,Lnum = SST.GetEntireConePathsAsLinks(sst,"fwd",leftptrs[0],ldepth,10)
		right_paths,Rnum = SST.GetEntireConePathsAsLinks(sst,"bwd",rightptrs[0],rdepth,10)		
