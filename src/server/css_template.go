...
var theme = make(map[string]map[string]string)
	...
	theme["dark"]["MATH_COLOUR"] = "lightblue"
	theme["dark"]["SST_ARROW_0_COLOUR"] = "var(--purple-4)"
	theme["dark"]["SST_ARROW_1_COLOUR"] = "var(--indigo-2)"
	theme["dark"]["SST_ARROW_2_COLOUR"] = "var(--red-5)"
	theme["dark"]["SST_ARROW_3_COLOUR"] = "var(--gray-3)"
	theme["dark"]["SST_ARROW_4_COLOUR"] = "var(--red-5)"
	theme["dark"]["SST_ARROW_5_COLOUR"] = "var(--indigo-2)"
	theme["dark"]["SST_ARROW_6_COLOUR"] = "var(--purple-4)"
	...
	theme["slate"]["SST_ARROW_0_COLOUR"] = "var(--purple-4)"
	theme["slate"]["SST_ARROW_1_COLOUR"] = "var(--indigo-2)"
	theme["slate"]["SST_ARROW_2_COLOUR"] = "var(--red-5)"
	theme["slate"]["SST_ARROW_3_COLOUR"] = "var(--gray-3)"
	theme["slate"]["SST_ARROW_4_COLOUR"] = "var(--red-5)"
	theme["slate"]["SST_ARROW_5_COLOUR"] = "var(--indigo-2)"
	theme["slate"]["SST_ARROW_6_COLOUR"] = "var(--purple-4)"
	...
	theme["spaceblue"]["SST_ARROW_0_COLOUR"] = "var(--purple-4)"
	theme["spaceblue"]["SST_ARROW_1_COLOUR"] = "var(--indigo-2)"
	theme["spaceblue"]["SST_ARROW_2_COLOUR"] = "var(--red-5)"
	theme["spaceblue"]["SST_ARROW_3_COLOUR"] = "var(--gray-3)"
	theme["spaceblue"]["SST_ARROW_4_COLOUR"] = "var(--red-5)"
	theme["spaceblue"]["SST_ARROW_5_COLOUR"] = "var(--indigo-2)"
	theme["spaceblue"]["SST_ARROW_6_COLOUR"] = "var(--purple-4)"
	...
	theme["red"]["SST_ARROW_0_COLOUR"] = "var(--pink-4)"
	theme["red"]["SST_ARROW_1_COLOUR"] = "var(--indigo-2)"
	theme["red"]["SST_ARROW_2_COLOUR"] = "var(--red-5)"
	theme["red"]["SST_ARROW_3_COLOUR"] = "var(--gray-3)"
	theme["red"]["SST_ARROW_4_COLOUR"] = "var(--red-5)"
	theme["red"]["SST_ARROW_5_COLOUR"] = "var(--indigo-2)"
	theme["red"]["SST_ARROW_6_COLOUR"] = "var(--pink-4)"
	...
	theme["style"]["FULL_TEXT_COLOUR"] = "var(--stone-10)"
	...
	theme["style"]["SST_ARROW_0_COLOUR"] = "purple"
	theme["style"]["SST_ARROW_1_COLOUR"] = "darkblue"
	theme["style"]["SST_ARROW_2_COLOUR"] = "red"
	theme["style"]["SST_ARROW_3_COLOUR"] = "var(--gray-6)"
	theme["style"]["SST_ARROW_4_COLOUR"] = "red"
	theme["style"]["SST_ARROW_5_COLOUR"] = "darkblue"
	theme["style"]["SST_ARROW_6_COLOUR"] = "purple"
